import { ChatboxView } from "./views/chatboxView.js";
...
(async () => {
  ...
  const [css, html] = await Promise.all([
    fetch(fromMainProject("./chatboxsdk/chatbox.css")).then((r) => r.text()),
    fetch(fromMainProject("./chatboxsdk/chatbox.html")).then((r) => r.text()),
  ]);
